    ...
    for sub_sub_folder_name in os.listdir(sub_folder_path):
        ...
        for vd in os.listdir(video_folder_path):
            ...
            if ext == '.mp4' or ext =='.avi':
                ...
                frame_path_format = os.path.join(video2frame_root_dir,sub_folder_name)

                if not os.path.isdir(frame_path_format):
                    os.mkdir(frame_path_format)
 
                frame_path_format = os.path.join(frame_path_format,sub_sub_folder_name)
                ...
                frame_path_format = os.path.join(frame_path_format,'img_{:06d}.jpg')
